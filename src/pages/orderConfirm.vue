<template>
  <div class="order-confirm">
        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked':index == checkIndex}" @click="checkIndex = index" v-for="(item,index) in list" :key="index">
                ...
                <div class="action">
                  <a href="javascript:;" class="fl" @click="openDeleteModal(item)">
              ...
              <div class="addr-add" @click="openAddModal">
          ...
          <div class="detail">
            <div class="item">
              ...
              <span class="item-val">{{totalQuantity}}件</span>
            </div>
            <div class="item">
    ...
    <modal
      ...
      @doChange="closeAddModal"
      @sure='addAddress'>
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            收件人 姓 名 <input type="text" class="input" placeholder="姓名" v-model="receiverName">
            <br>
            收件人手机号<input type="text" class="input" placeholder="手机号" v-model="receiverMobile">
          </div>
          <div class="item">
          ...
          <div class="item">
            <textarea name="street" v-model="receiverAddress"  placeholder="详细地址"></textarea>
          </div>
          <div class="item">
            <input type="text" class="input" placeholder="邮编" v-model="receiverZip">
          </div>
        </div>
      </template>
    </modal>
...
export default{
  ...
  data(){
    return {
      ...
      showDeleteModal:false,//是否显示删除弹框
      deleteId:'',
      editId:'',
      list:[],//收货地址列表
  ...
  methods:{
    ...
    deleteAddress(){
      this.axios.delete('/shippings/'+this.deleteId).then(()=>{
    ...
    editAddress(){
      this.axios.put('/shippings/'+this.editId,{
        receiverName:this.receiverName,
        receiverPhone:this.receiverPhone,
        receiverMobile:this.receiverMobile,
        receiverProvince:this.receiverProvince,
    ...
    getCartList(){
      this.axios.get('/carts').then((res)=>{
        this.cartList = res.cartProductVoList.filter((item)=>{
